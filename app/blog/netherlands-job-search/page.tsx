    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#7A7F94] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F1629]">Job Search in Netherlands</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Why the Netherlands?</h2>
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Best job boards in the Netherlands</h2>
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F1629]">LinkedIn:</strong> The dominant platform for professional jobs in the Netherlands. Many Dutch companies post exclusively on LinkedIn.</li>
          <li><strong className="text-[#0F1629]">Nationale Vacaturebank (NationaleVacaturebank.nl):</strong> The Netherlands' largest Dutch-language job board.</li>
          <li><strong className="text-[#0F1629]">Monsterboard.nl:</strong> A major generalist job board covering most sectors.</li>
          <li><strong className="text-[#0F1629]">Indeed.nl:</strong> Aggregates listings from across the Dutch job market.</li>
          <li><strong className="text-[#0F1629]">Intermediair.nl:</strong> Focused on higher education graduates and professionals.</li>
          <li><strong className="text-[#0F1629]">Jobbird.com:</strong> Good for English-language roles in international companies.</li>
        </ul>

        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Networking in the Netherlands</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Language requirements</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">The Dutch hiring process</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Salary expectations</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mt-12 border-t border-[#E2E1DC] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/netherlands-cv-format" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">CV conventions for Dutch employers</p>
            </Link>
            <Link href="/blog/eu-work-visa-guide" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">Kennismigrant visa explained</p>
            </Link>
            <Link href="/blog/best-job-boards-europe" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              <span className="text-2xl">eu</span>
              <p className="mt-2 text-sm font-semibold text-[#0F1629]">Best Job Boards in Europe</p>
              <p className="text-xs text-[#7A7F94] mt-1">Pan-European job platforms</p>
            </Link>
          </div>
        </div>
