    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#7A7F94] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F1629]">Italy CV Format</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">The Europass CV in Italy</h2>
        ...
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F1629]">Length:</strong> Two to three pages is common in Italy — more generous than Northern European markets.</li>
          <li><strong className="text-[#0F1629]">Layout:</strong> Clean and professional. The Europass template is widely accepted. Avoid overly creative designs.</li>
          <li><strong className="text-[#0F1629]">Work experience:</strong> Reverse chronological. Include company, role, dates, and detailed descriptions of responsibilities.</li>
          <li><strong className="text-[#0F1629]">Education:</strong> Italian employers value academic credentials highly, especially from recognised Italian universities.</li>
          <li><strong className="text-[#0F1629]">Languages:</strong> Italian is essential for most roles. English is valuable, particularly in Milan's international business community.</li>
        </ul>

        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">The cover letter (lettera di presentazione)</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Regional differences</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mt-12 border-t border-[#E2E1DC] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/spain-cv-format" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              <span className="text-2xl">es</span>
              <p className="mt-2 text-sm font-semibold text-[#0F1629]">Spain CV Format</p>
            ...
            <Link href="/blog/france-cv-format" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">Another formal Latin European market</p>
            </Link>
