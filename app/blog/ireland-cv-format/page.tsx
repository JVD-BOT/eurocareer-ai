    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#64748B] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F172A]">Ireland CV Format</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Ireland's job market</h2>
        ...
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F172A]">Length:</strong> Two pages is standard. One page for very junior roles or recent graduates, three pages for very senior roles only.</li>
          <li><strong className="text-[#0F172A]">Layout:</strong> Professional and clean. Simple formatting. Avoid heavy graphics or design elements unless you are in a creative role.</li>
          <li><strong className="text-[#0F172A]">Work experience:</strong> Reverse chronological. Include company, job title, dates, and 3-5 bullet points per role focusing on achievements and impact.</li>
          <li><strong className="text-[#0F172A]">Education:</strong> List qualifications with institution, dates, and grade. Irish employers value academic credentials.</li>
          <li><strong className="text-[#0F172A]">Skills:</strong> Include technical skills, language abilities, and any relevant certifications.</li>
        </ul>
        ...
        <div className="mt-12 border-t border-[#E2E8F0] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/uk-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              <span className="text-2xl">gb</span>
              <p className="mt-2 text-sm font-semibold text-[#0F172A]">UK CV Format</p>
              <p className="text-xs text-[#64748B] mt-1">Very similar conventions</p>
            </Link>
