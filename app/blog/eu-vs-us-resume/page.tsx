    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#7A7F94] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F1629]">EU vs US Resume</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">The biggest differences at a glance</h2>
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">1. Document name: Resume vs CV</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">2. Photos</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">3. Personal details</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">4. Length</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">5. Tone and language</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">6. The cover letter</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">7. Objective statements vs profiles</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Quick comparison table</h2>
        <div className="overflow-x-auto">
          <table className="text-sm text-slate-600 border-collapse w-full">
            <thead>
              <tr className="border-b border-[#E2E1DC]">
                <th className="text-left py-2 pr-4 text-[#0F1629] font-semibold">Feature</th>
                <th className="text-left py-2 pr-4 text-[#0F1629] font-semibold">US Resume</th>
                <th className="text-left py-2 text-[#0F1629] font-semibold">European CV</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-[#E2E1DC]"><td className="py-2 pr-4">Length</td><td className="py-2 pr-4">1 page</td><td className="py-2">1–2 pages</td></tr>
              <tr className="border-b border-[#E2E1DC]"><td className="py-2 pr-4">Photo</td><td className="py-2 pr-4">Never</td><td className="py-2">Often expected (varies by country)</td></tr>
              <tr className="border-b border-[#E2E1DC]"><td className="py-2 pr-4">Date of birth</td><td className="py-2 pr-4">Never</td><td className="py-2">Common in some countries</td></tr>
              <tr className="border-b border-[#E2E1DC]"><td className="py-2 pr-4">Cover letter</td><td className="py-2 pr-4">Declining</td><td className="py-2">Usually expected</td></tr>
        ...
        <div className="mt-12 border-t border-[#E2E1DC] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/german-cv-format" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">Most formal European market</p>
            </Link>
