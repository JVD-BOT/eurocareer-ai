      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        <nav aria-label="breadcrumb">
          <div className="flex items-center gap-2 text-sm text-[#64748B] mb-8">
            ...
            <span>/</span>
            <span className="text-[#0F172A]">German CV Format</span>
          </div>
        </nav>
        ...
        <div className="prose prose-slate max-w-none space-y-6">
          <h2 className="text-xl font-semibold text-[#0F172A] mt-8">The Lebenslauf</h2>
          ...
          <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Photo requirements</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Personal details</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <ul className="text-slate-600 space-y-2 list-disc list-inside">
            <li><strong className="text-[#0F172A]">Length:</strong> Two pages is standard. One page for very junior roles. Three pages for senior or academic positions.</li>
            <li><strong className="text-[#0F172A]">Layout:</strong> Tabular/structured format. Section headers in the left column, details in the right. Clean, precise, professional.</li>
            <li><strong className="text-[#0F172A]">Work experience (Berufserfahrung):</strong> Reverse chronological. Include exact dates (month and year), company name, city, job title, and responsibilities.</li>
            <li><strong className="text-[#0F172A]">Education (Ausbildung):</strong> Include all formal qualifications. German employers respect academic credentials and apprenticeships (Ausbildung).</li>
            <li><strong className="text-[#0F172A]">Skills (Kenntnisse):</strong> Language skills with CEFR levels, technical skills, and IT proficiencies.</li>
            <li><strong className="text-[#0F172A]">Hobbies (Hobbies/Interessen):</strong> A short hobbies section is acceptable in Germany — it shows personality. Keep it brief and relevant.</li>
          </ul>

          <h2 className="text-xl font-semibold text-[#0F172A] mt-8">The Anschreiben (cover letter)</h2>
          <p className="text-slate-600 leading-relaxed">
          ...
          <div className="mt-12 border-t border-[#E2E8F0] pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <Link href="/blog/austria-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
                ...
                <p className="text-xs text-[#64748B] mt-1">Closest comparison to Germany</p>
              </Link>
              <Link href="/blog/switzerland-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
                ...
                <p className="text-xs text-[#64748B] mt-1">German-speaking Swiss market</p>
              </Link>
              <Link href="/blog/cover-letter-europe" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
                ...
                <p className="text-xs text-[#64748B] mt-1">Country-by-country cover letter guide</p>
              </Link>
            </div>
          </div>
