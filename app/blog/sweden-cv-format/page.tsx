    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#64748B] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F172A]">Sweden CV Format</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Swedish workplace culture</h2>
        ...
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F172A]">Length:</strong> One to two pages. Swedes value brevity. Every sentence should earn its place.</li>
          <li><strong className="text-[#0F172A]">Layout:</strong> Clean and minimal. Good typography, white space, and clear section headers. Avoid cluttered designs.</li>
          <li><strong className="text-[#0F172A]">Work experience:</strong> Reverse chronological. Quantify your achievements where possible. Show impact, not just responsibilities.</li>
          <li><strong className="text-[#0F172A]">Education:</strong> List formal qualifications. Sweden has excellent universities — local degrees carry weight, but international qualifications are widely respected.</li>
          <li><strong className="text-[#0F172A]">Languages:</strong> Swedish proficiency is a significant advantage for most roles. English is almost universal in Swedish professional environments. List both with CEFR levels.</li>
        </ul>
        ...
        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Sweden's tech and startup scene</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mt-12 border-t border-[#E2E8F0] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/denmark-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              ...
              <p className="text-xs text-[#64748B] mt-1">Similar Scandinavian approach</p>
            </Link>
            <Link href="/blog/netherlands-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              ...
              <p className="text-xs text-[#64748B] mt-1">Another direct, flat-hierarchy culture</p>
            </Link>
