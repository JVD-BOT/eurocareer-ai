    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#64748B] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F172A]">Netherlands CV Format</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Dutch workplace culture</h2>
        ...
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F172A]">Length:</strong> One to two pages maximum. Dutch employers do not have patience for padding. Every line should add value.</li>
          <li><strong className="text-[#0F172A]">Layout:</strong> Clean, minimal, and well-structured. The simpler the better. Avoid decorative elements.</li>
          <li><strong className="text-[#0F172A]">Work experience:</strong> Reverse chronological with specific, quantified achievements. "Increased sales by 23%" beats "responsible for sales".</li>
          <li><strong className="text-[#0F172A]">Education:</strong> List your highest qualification prominently. Dutch employers value degrees but are equally impressed by practical experience.</li>
          <li><strong className="text-[#0F172A]">Languages:</strong> Dutch fluency is a significant advantage for most roles. English is near-universal in Dutch business. List both with CEFR levels.</li>
        </ul>

        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">The motivatiebrief</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Working in the Netherlands as a non-EU national</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mt-12 border-t border-[#E2E8F0] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/netherlands-job-search" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              ...
              <p className="text-xs text-[#64748B] mt-1">Where to find Dutch jobs</p>
            </Link>
            <Link href="/blog/denmark-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              <span className="text-2xl">dk</span>
              <p className="mt-2 text-sm font-semibold text-[#0F172A]">Denmark CV Format</p>
              <p className="text-xs text-[#64748B] mt-1">Similar direct culture</p>
            </Link>
            <Link href="/blog/eu-work-visa-guide" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              ...
              <p className="text-xs text-[#64748B] mt-1">The Kennismigrant visa explained</p>
            </Link>
          </div>
        </div>
