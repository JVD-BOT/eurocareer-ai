    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#64748B] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F172A]">Denmark CV Format</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">The Danish workplace culture</h2>
        ...
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F172A]">Length:</strong> One to two pages. Danes appreciate brevity. Two pages is the maximum for most roles.</li>
          <li><strong className="text-[#0F172A]">Layout:</strong> Clean and professional. A simple, well-structured document beats elaborate design. White space matters.</li>
          <li><strong className="text-[#0F172A]">Work experience:</strong> Reverse chronological. Include company, role, dates, and 2-3 bullet points per role describing what you actually did and achieved.</li>
          <li><strong className="text-[#0F172A]">Education:</strong> Include degrees and relevant professional training. Danish employers value continuous learning.</li>
          <li><strong className="text-[#0F172A]">Skills:</strong> Include language skills (Danish is a significant advantage) and technical skills relevant to the role.</li>
        </ul>
        ...
        <h2 className="text-xl font-semibold text-[#0F172A] mt-8">Cover letter in Denmark</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mt-12 border-t border-[#E2E8F0] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/sweden-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              <span className="text-2xl">se</span>
              <p className="mt-2 text-sm font-semibold text-[#0F172A]">Sweden CV Format</p>
              <p className="text-xs text-[#64748B] mt-1">Similar Scandinavian conventions</p>
            </Link>
            <Link href="/blog/netherlands-cv-format" className="p-4 rounded-xl border border-[#E2E8F0] hover:border-[#6366F1] transition-colors">
              ...
              <p className="text-xs text-[#64748B] mt-1">Another direct-style culture</p>
            </Link>
