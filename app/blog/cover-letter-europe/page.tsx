    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#7A7F94] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F1629]">Cover Letters in Europe</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Does Europe expect a cover letter?</h2>
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Country-by-country expectations</h2>
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F1629]">Germany and Austria:</strong> Formal, structured, and expected. Address it to a named person. One page maximum. Explain specifically why you want this role at this company.</li>
          <li><strong className="text-[#0F1629]">France:</strong> The lettre de motivation is a formal requirement. French employers place significant weight on it. Tone should be respectful and formal. Handwritten letters are uncommon but occasionally requested for some traditional roles.</li>
          <li><strong className="text-[#0F1629]">Netherlands:</strong> A shorter, more direct motivatiebrief is standard. Dutch employers value honesty and directness. Skip the flowery language — get to the point.</li>
          <li><strong className="text-[#0F1629]">UK and Ireland:</strong> Covering letters are expected. Tone is professional but less formal than Germany or France. One page. Focus on your value to the employer, not just what you want from the job.</li>
          <li><strong className="text-[#0F1629]">Spain:</strong> A carta de presentación is standard. Warm and personal in tone. Demonstrating genuine interest in the company culture matters.</li>
          <li><strong className="text-[#0F1629]">Sweden and Denmark:</strong> Cover letters are common but less strictly formal. Clarity and brevity are valued. Many Scandinavian employers appreciate seeing personality.</li>
        </ul>

        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Structure of a strong European cover letter</h2>
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F1629]">Opening:</strong> State the position you are applying for and where you saw it advertised. Show enthusiasm without being sycophantic.</li>
          <li><strong className="text-[#0F1629]">Body paragraph 1:</strong> Why you are qualified. Highlight 2-3 specific achievements or skills relevant to the role.</li>
          <li><strong className="text-[#0F1629]">Body paragraph 2:</strong> Why this company. Demonstrate research. Reference a recent initiative, product, or news item that resonates with you.</li>
          <li><strong className="text-[#0F1629]">Closing:</strong> Thank the reader, express interest in discussing further, and sign off appropriately for the country.</li>
        </ul>

        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Common mistakes across Europe</h2>
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Sign-off phrases by country</h2>
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F1629]">Germany:</strong> Mit freundlichen Grüßen</li>
          <li><strong className="text-[#0F1629]">France:</strong> Veuillez agréer, Madame, Monsieur, l'expression de mes salutations distinguées</li>
          <li><strong className="text-[#0F1629]">Netherlands:</strong> Met vriendelijke groet</li>
          <li><strong className="text-[#0F1629]">Spain:</strong> Atentamente</li>
          <li><strong className="text-[#0F1629]">UK/Ireland:</strong> Yours sincerely (if named) or Yours faithfully (if not)</li>
        </ul>
        ...
        <div className="mt-12 border-t border-[#E2E1DC] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/german-cv-format" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">CV guide for Germany</p>
            </Link>
            ...
            <Link href="/blog/best-job-boards-europe" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              <span className="text-2xl">eu</span>
              <p className="mt-2 text-sm font-semibold text-[#0F1629]">Best Job Boards</p>
              <p className="text-xs text-[#7A7F94] mt-1">Where to find jobs in Europe</p>
            </Link>
          </div>
        </div>
