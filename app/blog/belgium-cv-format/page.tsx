    ...
    <article className="max-w-2xl mx-auto px-4 py-16">
      ...
      <nav aria-label="breadcrumb">
        <div className="flex items-center gap-2 text-sm text-[#7A7F94] mb-8">
          ...
          <span>/</span>
          <span className="text-[#0F1629]">Belgium CV Format</span>
        </div>
      </nav>
      ...
      <div className="prose prose-slate max-w-none space-y-6">
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">Belgium's linguistic divide</h2>
        ...
        <ul className="text-slate-600 space-y-2 list-disc list-inside">
          <li><strong className="text-[#0F1629]">Length:</strong> One to two pages. Two pages is standard for experienced candidates.</li>
          <li><strong className="text-[#0F1629]">Layout:</strong> Clean and structured. Belgian employers appreciate clarity. Avoid excessive graphics.</li>
          <li><strong className="text-[#0F1629]">Work experience:</strong> Reverse chronological with dates, company names, job titles, and bullet-pointed responsibilities.</li>
          <li><strong className="text-[#0F1629]">Education:</strong> Include full educational history. Belgian employers value formal qualifications highly.</li>
          <li><strong className="text-[#0F1629]">Languages:</strong> Crucial in Belgium. List all languages with CEFR levels. Multilingualism is a significant advantage.</li>
        </ul>
        ...
        <h2 className="text-xl font-semibold text-[#0F1629] mt-8">EU institutions and international employers</h2>
        <p className="text-slate-600 leading-relaxed">
        ...
        <div className="mt-12 border-t border-[#E2E1DC] pt-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <Link href="/blog/france-cv-format" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">French-language CV conventions</p>
            </Link>
            <Link href="/blog/netherlands-cv-format" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">Dutch-language CV guide</p>
            </Link>
            <Link href="/blog/eu-work-visa-guide" className="p-4 rounded-xl border border-[#E2E1DC] hover:border-[#636DF5] transition-colors">
              ...
              <p className="text-xs text-[#7A7F94] mt-1">Working in the EU as a non-EU national</p>
            </Link>
          </div>
        </div>
