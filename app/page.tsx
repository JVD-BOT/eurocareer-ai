...
const HOW_IT_WORKS = [
  {
        ...
        desc: "Upload your CV once and you're set. EuroCareer AI uses it as the foundation for every country-specific adaptation.",
  },
  {
        step: "02",
        icon: "📋",
        title: "Track your applications",
        desc: "See every application at a glance — track where you stand, from first look to final offer.",
  },
  {
        step: "03",
        icon: "✨",
        title: "Generate with AI",
        desc: "Pick a country, click adapt. In seconds your CV speaks the local language — formatted to the standards recruiters in that country actually expect.",
  },
  ];
...
const FEATURES = [
  {
        ...
        desc: "See exactly where every application stands — at a glance. Filter by country or stage and never lose track of an opportunity.",
        tag: "Core",
  },
  {
        emoji: "📄",
        title: "AI CV Adapter",
        desc: "One click and your CV is restructured for the country you're targeting — format, length, and photo norms all handled.",
        tag: "AI",
  },
  {
        emoji: "💌",
        title: "Cover Letter Generator",
        desc: "Set your tone, get a personalised letter in seconds. Not happy? Regenerate with feedback until it's right.",
        tag: "AI",
  },
  {
        emoji: "🌍",
        title: "Country Intelligence",
        desc: "Know exactly what recruiters in each country expect — photo rules, CV length, language conventions, and more.",
        tag: "Core",
  },
  ];
...
const BLOG_POSTS = [
  {
        ...
        desc: "German CVs follow strict conventions around format, photo, and structure.",
  ...
  },
  {
        ...
        desc: "The Dutch job market is open to internationals — here is how to stand out.",
  ...
  },
  {
        ...
        desc: "Here is exactly what to change before you hit send on an EU application.",
...
const FAQS = [
  {
        ...
        a: "Germany, Netherlands, France, Sweden, Denmark, UK, Spain, Ireland, Belgium, Austria, Switzerland, and Italy — 12 countries total.",
  },
  {
        q: "How does the AI CV adapter work?",
        a: "Paste your existing CV, select the target country, and the AI rewrites it to match local hiring standards — format, length, photo norms, and more.",
  },
  {
        q: "Do I need ChatGPT or any other AI subscription?",
        a: "No. The AI is built directly into EuroCareer AI. Everything runs within the app — no third-party subscriptions needed.",
  },
  {
        q: "What is an AI credit?",
        a: "Each AI generation (CV adaptation or cover letter) uses one credit. Free accounts get 3 per month. Pro accounts get unlimited.",
  },
  {
        q: "Can I cancel my Pro subscription at any time?",
        a: "Yes. Cancel anytime from your billing page — no questions asked, no lock-in.",
  },
  {
        q: "Is my data secure?",
        a: "All data is stored in a Supabase database with Row Level Security. Only you can access your applications and documents.",
  },
  ];
        ...
        <div className="min-h-screen text-[#0F1629]" style={{ background: "#F8F8F6" }}>
          ...
          {/* HERO */}
                <section
                        ...
                        >
                  {/* Background video — hidden on mobile via .hero-video CSS */}
                  {!isMobile && (
                                    <video
                                                  src="/hero-loop.mp4"
                                                  autoPlay
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                                          ...
                                                          <span
                                                                                className={`text-xs font-semibold px-2 py-0.5 rounded-full ${
                                                                                                        f.tag === "AI"
                                                                                                          ? "bg-[#EEEFFE] text-[#636DF5]"
                                                                                                          : "bg-[#F3F2EE] text-[#7A7F94]"
                                                                                  }`}
                                                                              >
                                                            {f.tag === "AI" ? "✨ AI" : f.tag}
                                                          </span>span>
              ...
              <section id="pricing" className="py-20 max-w-5xl mx-auto px-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
                        ...
                        {/* Pro */}
                                <div
                                              ref={addReveal}
                                              className="reveal rounded-2xl border-2 bg-white p-8 space-y-4 relative"
                                              style={{ borderColor: "#636DF5" }}
                                            >
                                            <div
          ...
          {/* CTA */}
              <section
                        className="py-20 mx-4 sm:mx-8 mb-8 rounded-3xl text-white text-center relative overflow-hidden"
