...
const HOW_IT_WORKS = [
  {
        ...
        desc: "Add your CV once. EuroCareer AI stores it securely and uses it as the base for every adaptation and cover letter.",
  },
  {
        step: "02",
        title: "Track your applications",
        desc: "Log every job across the Kanban board — Researching, Applied, Responded, Interview, Offer, Rejected.",
  },
  {
        step: "03",
        title: "Generate with AI",
        desc: "Pick a country, click adapt. Get a country-specific CV and cover letter in seconds, ready to send.",
  },
  ];
...
const BLOG_POSTS = [
  {
        ...
        desc: "German CVs follow strict conventions — Lebenslauf format, photo requirements, and reverse chronology. Here's what you need to know.",
        href: "/blog/german-cv-format",
  },
  {
        tag: "Job Search",
        title: "Finding jobs in the Netherlands as a foreigner",
        desc: "The Dutch job market is open to internationals, but knowing where to look and how to apply makes a big difference.",
        href: "/blog/netherlands-job-search",
  },
  {
        tag: "CV Guide",
        title: "EU vs US resume: key differences explained",
        desc: "Applying to European companies with an American-style resume? Here's what to change before you hit send.",
...
const FAQS = [
  ...
  },
  {
        ...
        a: "No. The AI is built directly into EuroCareer AI — you don't need a separate ChatGPT, Claude, or any other subscription. Everything runs within the app.",
  },
  {
            ...
            {/* Country social proof bar */}
                <section className="border-y bg-gray-50 py-8">
                        <div className="max-w-5xl mx-auto px-6">
                          ...
                          <span
                                            key={c.code}
                                            className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-1.5 text-sm text-gray-700 font-medium shadow-sm"
                                          >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
                          {/* Free */}
                            ...
                            <li key={item} className="flex items-center gap-2">
                                              <span className="text-green-500 font-bold">✓</span>span>{item}
                            </li>li>
                          ))}
                                              </ul>ul>
                                              <Link
                          ...
                          {/* Pro */}
                            ...
                            "Early access to new features",
                                            ...
                                            <li key={item} className="flex items-center gap-2">
                                                              <span className="text-indigo-600 font-bold">✓</span>span>{item}
                                            </li>li>
                                          ))}
                                              </ul>ul>
                                              <Link
                ...
                <section className="bg-gray-50 py-20">
                        <div className="max-w-5xl mx-auto px-6">
                          ...
                          <Link
                                            key={post.title}
                                            href={post.href}
                                            className="bg-white rounded-2xl border p-6 hover:shadow-md transition-shadow flex flex-col gap-3"
                                          >
            ...
            {/* Final CTA */}
                <section className="py-20 bg-gray-900 text-white text-center">
                        <div className="max-w-xl mx-auto px-6">
                                  <img src="/ARROW.png" alt="" className="h-10 w-auto mx-auto mb-6 opacity-80 invert brightness-0 invert" />
                                  ...
                                  <Link
                                                href="/auth/signup"
                                                className="inline-block bg-white hover:bg-gray-100 text-gray-900 text-base font-semibold px-10 py-4 rounded-xl transition-colors"
                                              >
                                              Start free →
                                  </Link>Link>
