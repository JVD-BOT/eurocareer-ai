        ...
        return (
                <div className="min-h-screen flex items-center justify-center p-6" style={{ background: "#F8F8F6" }}>
                          <div className="w-full max-w-md text-center space-y-4">
                                    ...
                                    <h1 className="text-2xl font-bold" style={{ fontFamily: "'Outfit', sans-serif", color: "#0F1629" }}>Check your email</h1>h1>
                                    <p className="text-sm" style={{ color: "#7A7F94" }}>
                                                We sent a confirmation link to <strong style={{ color: "#3D4255" }}>{email}</strong>strong>. Click it to activate your account.
                                    </p>p>
                ...
                <div
                        ...
                        <div className="relative space-y-6">
                                  <h2
                                              ...
                                              <span
                                                              style={{
                                                                                background: "linear-gradient(135deg, #636DF5, #7C3AED)",
                        ...
                        <p className="relative text-xs" style={{ color: "#7A7F94" }}>
                                  © {new Date().getFullYear()} EuroCareer AI
                        </p>p>
                </div>div>
                          ...
                          {error}
                                  ...
                                  <div className="relative mb-4">
                                              <div className="absolute inset-0 flex items-center">
                                                            <span className="w-full border-t border-[#E2E1DC]" />
                                              </div>div>
                                              <div className="relative flex justify-center text-xs uppercase">
                                                            <span className="px-2 text-[#B0B4C5]" style={{ background: "#F8F8F6" }}>
                                  ...
                                  <form onSubmit={handleSignup} className="space-y-4">
                                              <div className="space-y-1.5">
                                                            <Label htmlFor="email" className="text-sm font-medium" style={{ color: "#3D4255" }}>
                                                                            Email
                                                            </Label>Label>
                                                            <Input
                                                                              id="email"
                                                                              ...
                                                                              className="h-11 rounded-xl border-[#E2E1DC] focus:border-[#636DF5] focus:ring-[#636DF5]/20"
                                                                            />
                                              </div>div>
                                              <div className="space-y-1.5">
                                                            <Label htmlFor="password" className="text-sm font-medium" style={{ color: "#3D4255" }}>
                                                                            Password
                                                            </Label>Label>
                                                            <Input
                                                                              id="password"
                                              ...
                                              <div className="space-y-1.5">
                                                            <Label htmlFor="confirmPassword" className="text-sm font-medium" style={{ color: "#3D4255" }}>
                                                                            Confirm password
                                                            </Label>Label>
                                                            <Input
                                                                              id="confirmPassword"
                                              ...
                                              <Button
                                                              type="submit"
                                                              className="w-full h-11 font-semibold rounded-xl text-white transition-all hover:-translate-y-0.5 hover:shadow-md"
                                              ...
                                              <p className="text-xs text-center" style={{ color: "#7A7F94" }}>
                                                            ...
                                                            <Link href="/terms" className="hover:underline" style={{ color: "#636DF5" }}>Terms</Link>Link>
                                                {" "}and{" "}
                                                            <Link href="/privacy" className="hover:underline" style={{ color: "#636DF5" }}>Privacy Policy</Link>Link>.
                                              </p>p>
                                  </form>form>
                        
                                  <p className="text-sm text-center mt-6" style={{ color: "#7A7F94" }}>
                                              Already have an account?{" "}
                                              <Link href="/auth/login" className="font-semibold hover:underline" style={{ color: "#636DF5" }}>
                                                            Sign in
                                              </Link>Link>
                                  </p>p>
                        </div>div>
